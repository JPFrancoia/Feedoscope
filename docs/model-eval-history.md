...
migrations. Miniflux owns the schema because Miniflux is the future reader of
the table.
...
Freshness does not write model-evaluation rows or require a
freshness-specific `model_evals` schema.
