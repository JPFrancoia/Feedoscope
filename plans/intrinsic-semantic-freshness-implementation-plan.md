...
- [x] Add focused tests for target/probability/artifact behavior.
- [x] Implement the five-head artifact module.
- [x] Implement label retrieval and training.
- [x] Implement inference and selected persistence.
- [x] Integrate the approved rollout into commands/orchestration.
- [x] Run formatting, lint, types, tests, and available DB checks.
- [x] Add/update durable docs for implemented behavior.
- [x] Leave all feature-branch changes uncommitted for user review.
...
8. **Decided — approval:** the user approved implementation start on 2026-07-26.
